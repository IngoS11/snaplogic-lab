...
docker run --sysctl kernel.shmmni=32768 --stop-timeout 7200 --restart unless-stopped \
     -i --name a4h -h vhcala4hci -p 3200:3200 -p 3300:3300 -p 4800:4800 -p 8443:8443 -p 30213:30213 \
     -p 50000:50000 -p 50001:50001 sapse/abap-platform-trial:1909_SP01 -agree-to-sap-license
